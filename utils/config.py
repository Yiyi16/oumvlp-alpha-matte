...
CONFIG.model.arch.encoder = "res_gca_encoder_29"
CONFIG.model.arch.encoder2 = "res_gca_encoder_29"
CONFIG.model.arch.decoder = "res_gca_decoder_22"
...
CONFIG.data.test_fg = None
CONFIG.data.test_bg = None
...
CONFIG.test.test_fg = None
CONFIG.test.test_bg = None
...
CONFIG.log.checkpoint_path = "./mycheckpoints"
